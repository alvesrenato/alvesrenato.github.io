...
const i18n = {
    ...
    en: {
        ...
        highlight2Desc: "Implementation of Google for Education ecosystem for thousands of users",
        ...
        exp2Title: "Front-End Developer and Branding Management",
    ...
    it: {
        ...
        highlight2Desc: "Implementazione dell'ecosistema Google for Education per migliaia di utenti",
        highlight3Title: "Automazione",
        ...
        footerText: "Design & Sviluppo proprio"
    }
};
...
function setupScrollReveal() {
    ...
    const revealElements = document.querySelectorAll(
        '.section-header, .about-text, .about-highlights, .skill-category, ' +
        '.timeline-item, .education-card, .contact-content'
    );
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { i18n, setLanguage, setTheme };
}
